 ...
 * generated in the br.com.calculadorapedro.ws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _Somar_QNAME = new QName("http://ws.calculadorapedro.com.br/", "somar");
    private final static QName _SomarResponse_QNAME = new QName("http://ws.calculadorapedro.com.br/", "somarResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: br.com.calculadorapedro.ws.client
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://ws.calculadorapedro.com.br/", name = "somar")
     ...
     */
    @XmlElementDecl(namespace = "http://ws.calculadorapedro.com.br/", name = "somarResponse")
